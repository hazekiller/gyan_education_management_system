...
router.get(
  "/rooms",
  requireRole(["super_admin", "admin", "principal", "vice_principal"]),
  hostelController.getAllRooms
);
router.post(
  "/rooms",
...
router.get(
  "/rooms/:id",
  requireRole(["super_admin", "admin", "principal", "vice_principal"]),
  hostelController.getRoomDetails
);
router.put(
  "/rooms/:id",
  requireRole(["super_admin", "admin", "principal"]),
...
router.get(
  "/my-room",
  requireRole(["student"]),
  hostelController.getStudentHostelDetails
);
